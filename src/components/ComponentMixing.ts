...
// Local.
import { ReadComponentInfo, ComponentInfo, ComponentInfoEmpty, ReadComponentInfos, ReadComponentRequiredInfo, ComponentInfoAny } from "./typesInfo";
...
export type ComponentFuncMixable<RequiredFunc extends ComponentFunc<ComponentInfoAny> = ComponentFunc, OwnInfo extends Partial<ComponentInfo> = {}> = ComponentFunc<ReadComponentInfo<RequiredFunc> & OwnInfo> & { _Required?: RequiredFunc; };
...
export function mixClassFuncs(BaseClass: ComponentType, ...funcArgs: ComponentFunc[] | [...funcs: ComponentFunc[], useClassRender: boolean | undefined]): ComponentType<ComponentInfoAny> {
    // Mix.
