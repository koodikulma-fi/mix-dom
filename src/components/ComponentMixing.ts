 ...
 */
export function mixFuncs<A extends ExtendsComponent<A, {}, ComponentFunc>>(a: A, ...extras: [name?: string, useRenderer?: boolean] | [useRenderer?: boolean, name?: string]): ComponentFunc<ReadComponentInfo<A>>;
export function mixFuncs<A extends ExtendsComponent<A, {}, ComponentFunc>, B extends ExtendsComponent<A, B, ComponentFunc>>(a: A, b: B, ...extras: [name?: string, useRenderer?: boolean] | [useRenderer?: boolean, name?: string]): ComponentFunc<ReadComponentInfos<[A, B]>>;
export function mixFuncs<A extends ExtendsComponent<A, {}, ComponentFunc>, B extends ExtendsComponent<A, B, ComponentFunc>, C extends ExtendsComponents<C, [A, B], ComponentFunc>>(a: A, b: B, c: C, ...extras: [name?: string, useRenderer?: boolean] | [useRenderer?: boolean, name?: string]): ComponentFunc<ReadComponentInfos<[A, B, C]>>;
...
export function mixFuncs(...args: [...funcs: ComponentFunc[], name: string | undefined, useRenderer: boolean | undefined] | [...funcs: ComponentFunc[], useRenderer: boolean | undefined] | ComponentFunc[]) {
    ...
    const FinalFunc = useCtx ?
        { [name]: (initProps: Record<string, any>, component: ComponentCtx, cAPI: ComponentContextAPI) => CompFunc(initProps, component, cAPI) }[name] :
        { [name]: (initProps: Record<string, any>, component: Component) => CompFunc(initProps, component) }[name];
    // Combine static side.
...
export function mixFuncsWith<ExtraInfo extends Partial<ComponentInfo>, A extends ExtendsComponent<A, {}, ComponentFunc>, Mixed extends ComponentFunc<ReadComponentInfo<A, ExtraInfo>>>(a: A, composer: Mixed, ...extra: [extraInfo?: ExtraInfo, name?: string] | [name?: string]): ComponentFunc<ReadComponentInfo<A, ExtraInfo>>;
export function mixFuncsWith<ExtraInfo extends Partial<ComponentInfo>, A extends ExtendsComponent<A, {}, ComponentFunc>, B extends ExtendsComponent<B, A, ComponentFunc>, Mixed extends ComponentFunc<ReadComponentInfos<[A, B], ExtraInfo>>>(a: A, b: B, composer: Mixed, ...extra: [extraInfo?: ExtraInfo, name?: string] | [name?: string]): ComponentFunc<ReadComponentInfos<[A, B], ExtraInfo>>;
export function mixFuncsWith<ExtraInfo extends Partial<ComponentInfo>, A extends ExtendsComponent<A, {}, ComponentFunc>, B extends ExtendsComponent<B, A, ComponentFunc>, C extends ExtendsComponents<C, [A, B], ComponentFunc>, Mixed extends ComponentFunc<ReadComponentInfos<[A, B, C], ExtraInfo>>>(a: A, b: B, c: C, composer: Mixed, ...extra: [extraInfo?: ExtraInfo, name?: string] | [name?: string]): ComponentFunc<ReadComponentInfos<[A, B, C], ExtraInfo>>;
 ...
 * - Note. If you want to define a custom base class (extending Component) you can use `mixClassMixins` method whose first argument is a base class.
 */
export function mixMixinsWith<ExtraInfo extends Partial<ComponentInfo>, A extends ExtendsComponent<A, {}, ComponentMixinType>, Info extends ReadComponentInfo<A, ExtraInfo>>(a: A, composer: ComponentMixinType<Info, Info>, ...extra: [extraInfo?: ExtraInfo, name?: string] | [name?: string]): ComponentType<Info>;
