...
*/
export function createShadow<Info extends Partial<ComponentInfo> = {}>(CompClass: ComponentType<Info>, signals?: Partial<ComponentShadowSignals<Info>> | null, ...args: [staticProps?: Partial<Info["static"]> | null, name?: string] | [name?: string]): ComponentShadowType<Info>;
